// ✅ FILE: client/src/pages/AddPet.jsx (with extended validation)
...
const AddPet = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validate()) return;
    try {
      await axios.post("http://localhost:5000/api/admin/pets", form, {
  ...
  return (
    <div className="min-h-screen bg-pink-50 px-4 py-10 font-sans">
      <div className="max-w-2xl mx-auto bg-white p-6 rounded-xl shadow-xl">
        <h2 className="text-2xl font-bold text-center text-pink-700 mb-6">Add New Pet ➕</h2>
